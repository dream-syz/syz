...
var hdCommon = (function () {
        ...
        com.getRelativeBeforeTime = function (dateType, dateTime) {
            var xHour;
            ...
            switch (dateType) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    xHour = 24 * getMonthDate(dateTime.slice(0, 4), dateTime.slice(5, 7));   //29
                    break;
                case "4":
                    xHour = 24 * getYearDate(dateTime.slice(0, 4));   //29
                    break;
            }
        ...
        com.resetTable = function (table) {
            ...
            var footer = parent.find(".fixed-table-footer table tr td");
